public class ChecklistGoal : Goal
{
    ...
    public ChecklistGoal(string goalName, string description, int pointsRewarded, int targetAmount, int amountCompleted, int bonus) : base(goalName, description, pointsRewarded)
    {
